 ...
 */
public final class PathReadResponse extends RestResponse<PathReadHeaders, Flowable<ByteBuffer>> implements Closeable {
    /**
     * Creates an instance of PathReadResponse.
     *
     ...
     */
    public PathReadResponse(HttpRequest request, int statusCode, PathReadHeaders headers, Map<String, String> rawHeaders, Flowable<ByteBuffer> body) {
     ...
     */
    @Override
    public PathReadHeaders headers() {
